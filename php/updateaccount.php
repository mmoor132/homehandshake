  ...
  <body>
    ...
    <!--Start of Form-->
      ...
      <!--Create Acount Button-->
        <center>
          <button class="btn" type="submit" name="submit" value="Submit" style="background-color: #002664; color: white">Alter Account</button>
        </center>
    ...
    <!--Script for Telephone Textbox-->
      <script>
        $(":input").inputmask();

        $("#phone").inputmask({"mask": "(999) 999-9999"});
      </script>
    <!--END Script for Telephone Textbox-->
  </body>
</html>